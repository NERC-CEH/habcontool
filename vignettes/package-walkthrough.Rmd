...
grids$central_grid_sf <- sf::st_sf(grids$central_grid_sf)
grids$central_grid_sf$pid <- seq(1:nrow(grids$central_grid_sf))

ggplot() +
  geom_sf(data = habs) +
  geom_sf(data = subset(grids$central_grid_sf, pid == 20), alpha = 0.5, aes(fill = pid))
...
suppressMessages(
  hab_overlaps <- habitat_overlap_gridded(spatial_object = habs, 
                                          ...
                                          plot_it = FALSE, 
                                          resolution = c(1000,1000),
                                          extent_large = grids[[2]][[20]],
                                          extent_central = grids[[1]][[20]], 
                                          save = FALSE, 
                                          save_loc, 
                                          save_name)
)
