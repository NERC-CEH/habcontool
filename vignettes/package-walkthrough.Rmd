...
It's worth playing around with the different parameters to see how it affects your results. As you'll see, the values you choose will have quite a large impact on the results you get out. 
For example, let's change the buffer to a much smaller value.
