...
### need to change this to get the bits at the extrior of the area (i.e. don't crop the outside polygons)

## probably need to change sum to number of overlaps
ggplot(hab_overlaps, aes(fill = n_overlaps)) +
  geom_sf()

ggplot(as.data.frame(overs$habitat_connectivity_raster, xy=TRUE), 
                aes(x=x, y=y, fill = n_overlaps)) +
  geom_tile()
